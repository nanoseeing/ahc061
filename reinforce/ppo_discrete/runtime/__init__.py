...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "save_agent_checkpoint": ("checkpoint", "save_agent_checkpoint"),
    "load_agent_checkpoint": ("checkpoint", "load_agent_checkpoint"),
    ...
    "extract_completed_episode_stats": ("episode_stats", "extract_completed_episode_stats"),
