...
from .native_vecnorm import NativeVecNormalize
from ...domains.ahc061.native_batch.interface import NativeBatchEnvProtocol, ensure_native_batch_env
from ...runtime.teacher_dataset import AHC061_OPP_PARAM_TRUE_TAIL_SHAPE, AHC061_OPP_VALID_TAIL_SHAPE
...
def create_native_rollout_workspace(
    env: NativeBatchEnvProtocol,
    *,
    num_steps: int,
    device: torch.device,
...
) -> NativeRolloutWorkspace:
    env = ensure_native_batch_env(env)
...
def collect_native_rollout(
    ...
    *,
    ...
    amp: bool = False,
    channels_last: bool = False,
    workspace: NativeRolloutWorkspace | None = None,
    pin_memory: bool = False,
    ...
    if workspace is None:
        workspace = create_native_rollout_workspace(
            env,
            num_steps=t_max,
            device=device,
