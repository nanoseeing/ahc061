...
_MODEL_PRESET_TABLE: dict[str, ModelPreset] = {
    "student_m_submit_v1": ModelPreset(
        ...
        note="Native submit-v1 student baseline.",
    ),
    "student_m_legacy_7ch": ModelPreset(
        id="student_m_legacy_7ch",
        model_config={
            "type": "StudentMBoardAgent",
            "kwargs": {
                "board_channels": 7,
        ...
        note="Legacy gym feature pipeline preset.",
    ),
    "teacher_p0_v1_88ch": ModelPreset(
        ...
        note="Teacher P0 v1 preset (native teacher feature supported).",
    ),
}
