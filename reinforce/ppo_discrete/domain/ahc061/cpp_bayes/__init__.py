...
_MODULE_NAME = "reinforce.ppo_discrete.domain.ahc061.cpp_bayes._opponent_bayes_cpp"
...
def _build_lock():
    ...
    repo_root = pkg_dir.parents[5]
    lock_path = repo_root / "reinforce" / "build" / "ahc061_cpp_bayes" / "opponent_bayes_cpp.build.lock"
